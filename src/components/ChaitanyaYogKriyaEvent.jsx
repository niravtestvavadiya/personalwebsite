...
function ChaitanyaYogKriyaEventView() {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        if (res.data && res.data.events) {
          const filteredEvents = res?.data?.events?.filter(event => event.category === "Chaitanya Yog Kriya");
  ...
  return (
    <div className="exce-specific-event-page-main">
      <section className="page-banner banner chaitanya-yog-banner banner-two">
        <Container>
          ...
          <Row>
            <Col xs={12} md={8} lg={8} className="me-auto">
              <div className="about-banner-content">
                ...
                <h1 className="banner-title">Chaitanya Yog Kriya  Event</h1>
              </div>
            </Col>
          </Row>
        </Container>
...
export default ChaitanyaYogKriyaEventView;
