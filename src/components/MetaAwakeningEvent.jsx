...
function MetaAwakeningEventView() {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        if (res.data && res.data.events) {
          const filteredEvents = res?.data?.events?.filter(event => event.category === "The Meta Awakening");
          ...
          <Row>
            <Col xs={12} md={8} lg={8} className="me-auto">
              <div className="about-banner-content">
                ...
                <h1 className="banner-title">The Meta Awakening Event</h1>
              </div>
            </Col>
          </Row>
        </Container>
...
export default MetaAwakeningEventView;
